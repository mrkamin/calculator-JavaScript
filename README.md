...
# 📖 [calculator-JavaScript] <a name="about-project"></a>

**[calculator-JavaScript]** This is a plain JavaScript project for the calculation app, using Html CSS and ES6 features. The calculator website is used for calculation numbers.👌
...
- [Live Demo Link](https://mrkamin.github.io/calculator-JavaScript/)
...
- Use `https://github.com/mrkamin/calculator-JavaScript` to clone the repository using the HTTPS link into your local machine
...
Feel free to check the [issues page](https://github.com/mrkamin/calculator-JavaScript/issues).
